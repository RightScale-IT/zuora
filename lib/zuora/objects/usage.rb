module Zuora::Objects
  class Usage < Base
    ...
    validates_presence_of :account_id, :unless => [:account_number, :charge_id, :subscription_id, :id]
    validates_presence_of :account_number, :unless => [:account_id, :charge_id, :subscription_id, :id]
    validates_presence_of :id, :unless => [:account_id, :charge_id, :subscription_id, :account_number]
    ...
    validates_presence_of :uom, unless: :id 
